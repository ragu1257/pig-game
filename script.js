...
// Get modal and start button elements
...
const scores = [0, 0];
let activePlayer = 0;
let playing = false; // Game is not active until the modal is closed
let currentScore = 0;
...
// Close the modal and start the game when the start button is clicked
...
btnHold.addEventListener("click", function () {
  if (playing) {
    ...
    // 2. check if player's score is >= 50   ----> finish the game
